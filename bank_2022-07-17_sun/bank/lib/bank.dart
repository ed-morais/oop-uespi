...
void main() {
  ...
  Account account =
      accounts.firstWhere((account) => account is InvestmentAccount);

  account.statement();
  account.dailyBalance((date, dailyBalance, totalBalance) {
    print(
        '${dateToDDMMYY(date)}\t${dailyBalance.toStringAsFixed(2)}\t${totalBalance.toStringAsFixed(2)}');
  });
}
